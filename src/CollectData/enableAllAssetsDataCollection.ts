...
import Driver from './adapterLayer/AllAssetsDataCollectorDriver'
...
export function enableAllAssetsDataCollection(
  routePath: string,
  httpVerb: 'get' | 'post',
  dependencies: {
    app: Express
  ...
  const requestHandler: RequestHandler = async (req, res, next) => {
    ...
    await driver.collectData(req.body)
  }
  dependencies.app[httpVerb](routePath, requestHandler)
}

export default enableAllAssetsDataCollection
